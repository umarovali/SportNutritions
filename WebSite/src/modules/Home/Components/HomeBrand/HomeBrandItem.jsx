...
export default function HomeBrandItem({ item }) {
    ...
    return (
        <li className="flex flex-col items-center gap-[4px] cursor-pointer">
            <Link to={`/catalog/brand=${item.id}`} className="flex flex-col items-center gap-[4px] cursor-pointer">
