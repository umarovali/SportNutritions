...
const AccessAddSelectCtegroy = ({ setCategroyAccess }) => {
    const [data, setData] = useState([]);
    ...
    const handleChange = (e) => {
        setCategroyAccess(e.target.value);
    };
...
export { NutritionAddSelectBrand, NutritionAddSelectCategory, NutritionAddSelectGoals, AccessAddSelectCtegroy };