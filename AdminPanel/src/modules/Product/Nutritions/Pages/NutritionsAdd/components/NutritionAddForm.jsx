...
import { NutritionAddSelectBrand, NutritionAddSelectGoals, NutritionAddSelectCategory } from "../../../../components/ProductAddSelect/ProductAddSelect";
        ...
        <section>
            <div className="container">
                <form onSubmit={createNutrition} className='pt-[20px] px-[8px] flex flex-col gap-[8px] mt-[50px] pb-[95px]'>
                    ...
                    <ProductAddUploadVideo setVideo={setVideo} />
