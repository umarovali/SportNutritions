...
import { FaPersonWalkingArrowRight, FaEyeSlash } from "react-icons/fa6";
    ...
    return (
        <div className="bg-[#000] relative w-[100%] h-[100svh]">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full text-center">
                ...
                <form onSubmit={handleSubmit} className="w-[80%] pt-[40px] flex flex-col gap-[20px]">
                    ...
                    <div className="flex flex-col gap-[10px]">
                        ...
                        <div className="flex gap-[0px]">
                            <input
                                ref={elPassword}
                                className="w-[100%] h-[45px] bg-transparent border-[1px] border-[#fff] rounded-[10px] pl-[10px] rounded-r-[0px] border-r-0 font-golos text-[#fff] text-[16px]"
                                placeholder="Пароль..."
